...
python plot_pg19.py --run-dirs \
    ...
    logs/exp14long_Dragon-L-GDN-independent_gn_unique-qk_norm_for_local-new_rmsnormweights-adamw_64266a14 \
    ...
    exp14-independent_unique-qknorm_for_local-new_weights \
