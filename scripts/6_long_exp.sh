...
#SBATCH --error=logs/experiment6_long_newcodebase.err            # standard error file
#SBATCH --output=logs/experiment6_long_newcodebase.out           # standard output file
...
srun torchrun ${DISTRIBUTED_ARGS[@]} main.py \
    --run_name exp6long_GPT2-L-new_codebase-skyladder-adamw \
    --model "gpt" \
    --attn_type "diff" \
    --scalable_softmax   \
    --d_model 1280 \
