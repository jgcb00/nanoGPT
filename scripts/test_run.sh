...
#SBATCH --error=logs/test_run.err            # standard error file
#SBATCH --output=logs/test_run.out           # standard output file
...
echo "Running with model size: $MODEL_SIZE, Setup mode: $SETUP_MODE" | tee -a $SBATCH_OUT
