...
python eval.py \
    --run_dir logs/exp14_Dragon-L-GDN-rope_to_nope-skyladder-repart_middle-rope_local477-adamw_7e9ea831 \
    --tasks niah_single_3 \
    --prompt_len 8192 \

python eval.py \
    --run_dir logs/exp14_Dragon-L-GDN-rope_to_nope-skyladder-repart_middle-rope_local163-adamw_25ef6baa \
    --tasks niah_single_3 \
    --prompt_len 8192 \
...
python eval.py \
    --run_dir logs/exp14_Dragon-L-GDN-rope_to_nope-adamw_dbbb4776 \
    --tasks niah_single_3 \
    --prompt_len 8192 \
