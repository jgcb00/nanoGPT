...
#SBATCH --error=logs/experiment10_ter.err            # standard error file
#SBATCH --output=logs/experiment10_ter.out           # standard output file
...
srun torchrun ${DISTRIBUTED_ARGS[@]} main.py \
    --run_name exp10_ter-Dragon-L-base_with_swa-adamw \
    --model dragon \
    --d_model 1280 \
    --n_heads 20 \
    --n_kv_heads 10 \
