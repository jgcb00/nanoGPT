...
#SBATCH --error=logs/experiment13_longrun_full_groupnorm_shared.err            # standard error file
#SBATCH --output=logs/experiment13_longrun_full_groupnorm_shared.out           # standard output file
...
srun torchrun ${DISTRIBUTED_ARGS[@]} main.py \
    --run_name exp13long_Dragon-L-GDN-ss_warmedup-skyladder-repart_middle-rope1k-groupnorm_full_shared-adamw \
    --no-groupnorm_unique \
