...
#SBATCH --error=logs/experiment27c.err
#SBATCH --output=logs/experiment27c.out
...
srun torchrun ${DISTRIBUTED_ARGS[@]} main.py \
    --run_name exp27_FINETUNING_Dragon-L-GDN-gta_no_kvsharing-gtda-state_passing-ft_same_LR-adamw \
    --checkpoint 'logs/exp14long_Dragon-L-GDN-softcap_diff_50-adamw_53512171/state_step032990.pt' \
    --p_state_passing 0.9 \
    --step_state_passing 0 \
