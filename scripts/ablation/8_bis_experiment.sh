...
#SBATCH --error=logs/experiment8_bis.err            # standard error file
#SBATCH --output=logs/experiment8_bis.out           # standard output file
...
srun torchrun ${DISTRIBUTED_ARGS[@]} main.py \
    --run_name exp8-bis_GPT2-L-full-stable_spam_paper_lr \
    --d_model 1280 \
    --n_heads 20 \
    --n_kv_heads 10 \
    --n_layers 36 \
