...
#SBATCH --error=logs/experiment27b.err
#SBATCH --output=logs/experiment27b.out
...
srun torchrun ${DISTRIBUTED_ARGS[@]} main.py \
    --run_name exp27_Dragon-L-GDN-gta_no_kvsharing-gtda-state_passing_40%-adamw \
    --p_state_passing 0.9 \
    --step_state_passing 13196 \
