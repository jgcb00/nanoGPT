...
#SBATCH --error=logs/experiment21_longrun_gta_nokvsharing_gtda.err
#SBATCH --output=logs/experiment21_longrun_gta_nokvsharing_gtda.out
...
srun torchrun ${DISTRIBUTED_ARGS[@]} main.py \
    --run_name exp21long_Dragon-L-GDN-gta_nokvsharing_gtda_adamw \
    --no-input_norm \
    --no-full_lambdas \
    --eps_rmsnorm 1.0e-6 \
    --groupnorm_unique \
