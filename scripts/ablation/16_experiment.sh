...
#SBATCH --error=logs/experiment16.err            # standard error file
#SBATCH --output=logs/experiment16.out           # standard output file
...
srun torchrun ${DISTRIBUTED_ARGS[@]} main.py \
    --run_name exp16_Dragon-L-full-stable_spam \
    --model dragon \
    --d_model 1280 \
    --n_heads 20 \
    --n_kv_heads 10 \
