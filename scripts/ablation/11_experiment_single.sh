...
#SBATCH --error=logs/experiment11_2avril.err            # standard error file
#SBATCH --output=logs/experiment11_2avril.out           # standard output file
...
srun torchrun ${DISTRIBUTED_ARGS[@]} main.py \
    --run_name exp11_Dragon-L-GDN-layer_norm_scaling-nsa-adamw \
    --model dragon \
    --attn_type nsa \
    --lin_attn_type gdn \
    --d_model 1280 \
