...
#SBATCH --error=logs/experiment13_GDN_SL.err            # standard error file
#SBATCH --output=logs/experiment13_GDN_SL.out           # standard output file
...
srun torchrun ${DISTRIBUTED_ARGS[@]} main.py \
    --run_name exp13_Dragon-L-GDN-scalable_softmax-dff-deepseekinit-skyladder_0.6-adamw \
