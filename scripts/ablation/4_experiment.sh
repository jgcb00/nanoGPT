...
#SBATCH --error=logs/experiment4.err            # standard error file
#SBATCH --output=logs/experiment4.out           # standard output file
...
srun torchrun ${DISTRIBUTED_ARGS[@]} main.py \
    --run_name exp4_GPT2-L-cross_layer_kv_sharing-adamw \
    --d_model 1280 \
    --n_heads 20 \
    --n_kv_heads 10 \
    --n_layers 36 \
