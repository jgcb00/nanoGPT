...
#SBATCH --error=logs/experiment11.err            # standard error file
#SBATCH --output=logs/experiment11.out           # standard output file
...
srun torchrun ${DISTRIBUTED_ARGS[@]} main.py \
    --run_name exp11_Dragon-L-layer_norm_scaling-adamw \
    --model dragon \
    --d_model 1280 \
    --n_heads 20 \
    --n_kv_heads 10 \
