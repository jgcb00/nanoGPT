...
#SBATCH --job-name=w2048_lr5E-4
#SBATCH --error=logs/exp14u_w2048_LR5.290E-4.err
#SBATCH --output=logs/exp14u_w2048_LR5.290E-4.out
...
srun torchrun ${DISTRIBUTED_ARGS[@]} main.py \
    --run_name test_uscaling_w2048_LR5.290E-4 \
    ...
    --uscaling_lr_other 5.290e-4 \
    --num_iterations 32990 \
    --warmup_iters 0.0045 \
    --warmdown_iters 0.15 \
    --weight_decay 5.290e-5 \
