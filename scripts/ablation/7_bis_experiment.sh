...
#SBATCH --error=logs/experiment7_bis.err            # standard error file
#SBATCH --output=logs/experiment7_bis.out           # standard output file
...
srun torchrun ${DISTRIBUTED_ARGS[@]} main.py \
    --run_name exp7-bis_GPT2-L-full-spam_paper_lr \
    --d_model 1280 \
    --n_heads 20 \
    --n_kv_heads 10 \
    --n_layers 36 \
