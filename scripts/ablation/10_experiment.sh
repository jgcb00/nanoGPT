...
#SBATCH --error=logs/experiment10.err            # standard error file
#SBATCH --output=logs/experiment10.out           # standard output file
...
srun torchrun ${DISTRIBUTED_ARGS[@]} main.py \
    --run_name exp10_Dragon-L-base_custom_patch-adamw \
