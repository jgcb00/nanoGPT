...
#SBATCH --error=logs/experiment27d.err
#SBATCH --output=logs/experiment27d.out
...
srun torchrun ${DISTRIBUTED_ARGS[@]} main.py \
    --run_name exp27_FINETUNING_Dragon-L-GDN-gta_no_kvsharing-gtda-state_passing-ft_LR/10-adamw \
