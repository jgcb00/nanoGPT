...
#SBATCH --error=logs/experiment1_quater.err            # standard error file
#SBATCH --output=logs/experiment1_quater.out           # standard output file
...
# PLT "unconstrained compute mode"
# ie, feed 20B tokens with lambda=0.67. K=4
# with stepfunc BS and LR: 441891 and 0.001198

srun torchrun ${DISTRIBUTED_ARGS[@]} main.py \
    --run_name exp1_GPT2-L-patch_level_0.67_20B_stepLRBS-adamw \
