...
with ctx:
    ...
    generated2 = model.generate(list(torch.unbind(prompt, dim=0)), n_tokens=[10]*bsz, sample=False)
    generated3 = model.generate_new(list(torch.unbind(prompt, dim=0)), n_tokens=[10]*bsz, sample=False, stop_tokens=stop_tokens)
