...
# load tokens
train_loader = DistributedDataLoader('../nanoGPT/data/fineweb100B/fineweb_train_*.bin', B, T, ddp_rank, ddp_world_size, score_pattern='data/exp0_GPT2-xs-scorer_25f0c569/scores_*.bin')
val_loader = DistributedDataLoader('../nanoGPT/data/fineweb100B/fineweb_val_*.bin', B, T, ddp_rank, ddp_world_size)
